  ...
  return (
    <div className="container mx-auto p-4 bg-white dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      ...
      <div className="relative">
        ...
        />
        {searchTerm && (
          <div className="absolute top-full left-0 right-0 bg-white dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-b-md shadow-lg z-10 max-h-96 overflow-y-auto">
            {searchResults.length > 0 ? (
              <ul>
                {searchResults.map((result) => (
                  <li key={`${result.noteId}-${result.matchText}`} className="border-b border-gray-200 dark:border-gray-700 last:border-b-0">
