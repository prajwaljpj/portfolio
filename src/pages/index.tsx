...
export default function Home() {
  return (
    <div className="bg-gray-900 text-white min-h-screen font-sans dark:bg-gray-100 dark:text-gray-900">
      <Header />
      <main className="container mx-auto p-4 pt-10 md:pt-20 max-w-full">
        {/* Hero Section */}
